...
async function runAllTests() {
  ...
  tests.push(await runTest(
    'Valid 8-digit phone number',
    `${BASE_URL}/api/check/98297150`,
    200
  ));
  ...
  tests.push(await runTest(
    ...
    `${BASE_URL}/api/check/59898297150`,
    200
  ));
  ...
  tests.push(await runTest(
    ...
    `${BASE_URL}/api/check/123`,
    400
  ));
  
  // Test 5: Another valid mobile number
  tests.push(await runTest(
    'Another valid mobile number',
    `${BASE_URL}/api/check/99123456`,
    200
  ));
